...
namespace Isometric_test_1
{
    public class GameWorld : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            Window.ClientSizeChanged += RunWhenWindowChangeSize;     // add and subscribe to deleagte method, will be called when window is changed
            RunWhenWindowChangeSize(null, null);                     // (no object, no event)
        ...
        private void RunWhenWindowChangeSize(object sender, EventArgs e)
        {
